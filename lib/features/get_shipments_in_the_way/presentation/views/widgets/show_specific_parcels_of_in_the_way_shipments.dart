...
import 'package:warehouse_subul/features/get_shipments_in_the_way/presentation/views/widgets/custom_parcel_of_in_the_way_shipments.dart';
...
class ShowSpecificParcelsOfInTheWayShipments extends StatelessWidget {
  ...
  const ShowSpecificParcelsOfInTheWayShipments({super.key, required this.shipmentId});
