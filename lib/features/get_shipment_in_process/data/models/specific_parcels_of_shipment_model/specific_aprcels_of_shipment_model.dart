...
class SpecificAprcelsOfShipmentModel extends SpecificParcelsOfShipmentEntity{
	int? id2;
	int? shipmentId2;
	...
	SpecificAprcelsOfShipmentModel({
		this.id2, 
		this.shipmentId2, 
		this.actualWeight2, 
	...
	factory SpecificAprcelsOfShipmentModel.fromJson(Map<String, dynamic> json) {
		return SpecificAprcelsOfShipmentModel(
			id2: json['id'] as int?,
